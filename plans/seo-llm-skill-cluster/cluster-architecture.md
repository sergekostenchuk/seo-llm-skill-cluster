...
| Task-plan governance | existing `task-plan-v2-orchestrator` | reuse installed skill | TASK-PLAN v2 structure, pre-implementation gates, alarms, task status policy. | Site-growth domain expertise. | Consumed by `site-growth-orchestrator`; not replaced. |
